...
> **Status 2026-09-24.** Brief 1 became Design Update 23 and shipped. Update 24 delivered part of brief 4. Every open step of briefs 2, 3 and 4 is tracked as an objective in [the roadmap](../../roadmap.md), with sources written `R2.x` / `R3.x` / `R4.x`. The briefs are kept as the review record.
