...
> **Superseded 2026-09-24 by [GDD v2](../game_design.md).** This is the v1 Game Design Document, kept as history. GDD v2 keeps these section numbers for §1–§11, so code comments citing "GDD §n" land on the same topic in both; where they disagree, GDD v2 wins.
