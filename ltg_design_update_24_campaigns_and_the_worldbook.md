...
**Status:** APPROVED 2026-09-06 (design settled with the owner; not yet implemented). Supersedes Update 17's "Standard / Everquest" option (§D17-1, §D17-7, the ladder row 7 in §D17-0) and the "inter-town travel" open question in §D17-10. Where this document and any prior document disagree, this document wins.
