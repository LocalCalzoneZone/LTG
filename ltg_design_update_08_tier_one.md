...
- **Counters remain.** Concluding stops the *ticking*; the accumulated −0/−1 counters persist like any counters (until removed, annihilated by regen, or the encounter ends).
...
- **Poison counter** — a persistent −0/−1 placed by a poison effect on resolution and at each Upkeep until the effect concludes (death, any received healing, or its turn bound). Not damage; never breaks a channel.
